data {
  ...
  int<lower=1> K;                 // number of trend covariates (e.g. 1=linear, 2=quadratic)
  matrix[I, K] X_date;            // design matrix (e.g. centered years, centered years^2)
  array[I] int<lower=0, upper=1> has_date;  // whether model i participates in trend (e.g. exclude human)
}
